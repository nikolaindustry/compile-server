...
| `customLibraries` | object[] | no | `[]` | Custom libraries as files or ZIPs. Format: `[{name: "MyLib", files: [{path: "src/MyLib.h", content: "..."}]}]` OR `[{name: "MyLib", zipBase64: "base64-encoded-zip"}]` |
